...
public final class MessageServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.stevenpg.rvg.MessageService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.stevenpg.rvg.Message,
      com.stevenpg.rvg.Result> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = com.stevenpg.rvg.Message.class,
      responseType = com.stevenpg.rvg.Result.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.stevenpg.rvg.Message,
      com.stevenpg.rvg.Result> getSendMethod() {
    io.grpc.MethodDescriptor<com.stevenpg.rvg.Message, com.stevenpg.rvg.Result> getSendMethod;
    if ((getSendMethod = MessageServiceGrpc.getSendMethod) == null) {
      synchronized (MessageServiceGrpc.class) {
        if ((getSendMethod = MessageServiceGrpc.getSendMethod) == null) {
          MessageServiceGrpc.getSendMethod = getSendMethod =
              io.grpc.MethodDescriptor.<com.stevenpg.rvg.Message, com.stevenpg.rvg.Result>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stevenpg.rvg.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.stevenpg.rvg.Result.getDefaultInstance()))
  ...
  public static abstract class MessageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(com.stevenpg.rvg.Message request,
        io.grpc.stub.StreamObserver<com.stevenpg.rvg.Result> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.stevenpg.rvg.Message,
                com.stevenpg.rvg.Result>(
                  this, METHODID_SEND)))
          .build();
    }
  }
  ...
  public static final class MessageServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MessageServiceBlockingStub> {
    ...
    /**
     */
    public com.stevenpg.rvg.Result send(com.stevenpg.rvg.Message request) {
  ...
  public static final class MessageServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MessageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.stevenpg.rvg.Result> send(
        com.stevenpg.rvg.Message request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((com.stevenpg.rvg.Message) request,
              (io.grpc.stub.StreamObserver<com.stevenpg.rvg.Result>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessageServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.stevenpg.rvg.MessageOuterClass.getDescriptor();
    }
